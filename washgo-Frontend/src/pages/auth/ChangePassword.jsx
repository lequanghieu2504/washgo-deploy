    ...
    try {
      const res = await fetch(`${API}/api/user/reset-password`, {
        ...
        headers: {
          ...
          Authorization: `Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJjbGllbnR1c2VyIiwicm9sZSI6IkNMSUVOVCIsImV4cCI6MTc1MDMxODY0OCwiaWF0IjoxNzUwMzE2ODQ4LCJ1c2VySWQiOjJ9.TDBrCujTyzooGSraD-jn7SZ4AksXMITs90krzGKtu6w`,
        },
